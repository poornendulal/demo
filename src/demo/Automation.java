	...
	try{
		...
		for( i=0;i<operation.length;i++){
			...
			if (operation[i]=='i'){
			     ...
			     System.out.println(webElement1a.getAttribute("Type")+" Type identified. SendKeys command will be performed with '"+testdata[k]+"' test data.");
			     webElement1a.sendKeys(testdata[k++]);
			}else if (operation[i]=='b'){
				WebDriverWait waiter = new WebDriverWait(driver, 30);
			    WebElement webElement1a = waiter.until(ExpectedConditions.visibilityOfElementLocated(By.id(control[j++])));
			    System.out.println(webElement1a.getAttribute("Type")+" Type identified. Click command will be performed.");
			    webElement1a.click();
			    ...
			    System.out.println(webElement1a.getTagName()+" control identified. Click command will be processed.");
			    webElement1a.click();
			    ...
			    System.out.println(webElement1a.getAttribute("Type")+" Type identified. Click command will be processed.");
			    webElement1a.click();
			}else if (operation[i]=='d'){
				WebDriverWait waiter = new WebDriverWait(driver, 30);
			    WebElement webElement1a = waiter.until(ExpectedConditions.visibilityOfElementLocated(By.id(control[j++])));
			    Select dropdown = new Select(webElement1a);
			    System.out.println(webElement1a.getTagName()+" control identified. Select command will be performed with '"+testdata[k]+"' test data.");
			   // dropdownselectByValue(testdata[k++]);
			}else if (operation[i]=='v'){
				WebDriverWait waiter = new WebDriverWait(driver, 30);
			    WebElement webElement1a = waiter.until(ExpectedConditions.visibilityOfElementLocated(By.id(control[j++])));
			    
			    System.out.println(webElement1a.getTagName()+" control identified. Verification will be performed with '" +testdata[k]+ "' test data.");
